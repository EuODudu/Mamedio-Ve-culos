        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 px-4">
          {trustPoints.map((point, index) => {
            ...
            return (
              <div
                key={point.title}
                className="trust-item opacity-0 bg-card rounded-xl p-5 md:p-6 border border-border hover:border-accent/50 transition-all duration-300 hover:shadow-card text-center"
              >
