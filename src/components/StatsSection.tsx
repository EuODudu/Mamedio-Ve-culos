    ...
    <section ref={sectionRef} className="section-padding bg-card relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-8 md:mb-12 px-4">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 md:mb-12">
            Resultados que{" "}
          ...
          <div className="max-w-5xl mx-auto space-y-4 sm:space-y-6 px-4 mb-8 md:mb-12">
            {/* Transparência em cada decisão */}
            <div className="text-left">
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-foreground mb-2 sm:mb-3 md:mb-4 flex items-center gap-2 md:gap-3">
                <span className="w-1 h-6 sm:h-8 md:h-12 bg-gradient-to-b from-accent to-accent/50 rounded-full flex-shrink-0"></span>
                <span>Transparência em cada decisão</span>
              </h3>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground leading-relaxed pl-3 md:pl-5">
            ...
            <div className="text-left">
              ...
              <div className="bg-background/50 backdrop-blur-sm rounded-xl p-3 sm:p-4 md:p-6 border border-accent/20 pl-3 md:pl-5">
            ...
            <div className="max-w-4xl mx-auto pt-4 sm:pt-6 md:pt-8">
              <div className="relative">
                ...
                <p className="relative text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-foreground px-3 py-3 sm:px-4 sm:py-4 md:px-8 md:py-6 bg-card/80 backdrop-blur-sm rounded-xl border border-accent/30 text-center leading-relaxed">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6 px-4">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                <div className="bg-background rounded-xl p-3 sm:p-4 md:p-6 border border-border hover:border-accent/50 transition-all duration-300 hover:shadow-card hover:-translate-y-1 h-full">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 mx-auto mb-2 sm:mb-3 md:mb-4 rounded-full bg-accent/10 flex items-center justify-center group-hover:bg-accent/20 transition-colors">
                  ...
                  <p className="text-[10px] sm:text-xs md:text-sm text-muted-foreground leading-tight px-1">{stat.label}</p>
                </div>
              </div>
            );
          })}
