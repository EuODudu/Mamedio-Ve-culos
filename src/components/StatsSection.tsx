        ...
        <div className="text-center mb-8">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <div className="relative inline-block">
              ...
              <p className="relative text-2xl md:text-3xl lg:text-4xl font-bold text-foreground px-8 py-6 bg-card/50 backdrop-blur-sm rounded-xl border border-accent/20">
                Não prometemos.{" "}
          ...
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="text-left">
              <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4 flex items-center gap-3">
                <span className="w-1 h-12 bg-gradient-to-b from-accent to-accent/50 rounded-full"></span>
                Transparência em cada decisão
              </h3>
