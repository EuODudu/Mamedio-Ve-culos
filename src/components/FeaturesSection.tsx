        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 px-4">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={feature.title}
                className="feature-item opacity-0 bg-card rounded-xl p-5 md:p-6 border border-border hover:border-accent/50 transition-all duration-300 hover:shadow-card hover:-translate-y-1 group"
              >
